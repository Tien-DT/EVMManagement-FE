...
const SEPayReturnPage = () => {
  ...
  useEffect(() => {
    const processPaymentReturn = async () => {
      try {
        // Get all query parameters from SEPay
        const params = {};
        for (const [key, value] of searchParams.entries()) {
          params[key] = value;
        }

        console.log('SEPay return params:', params);

        // Call backend to verify payment
        const response = await axiosInstance.get(endpoints.payments.sepayReturn, {
          params: params
        });
        ...
        {paymentResult && (
          ...
          >
            ...
            <Descriptions.Item label="Mã giao dịch SEPay">
              {paymentResult.vnpayTransactionNo || paymentResult.transactionId || 'N/A'}
            </Descriptions.Item>
...
export default SEPayReturnPage;
