...
export default function EvmStaffVehicleModelDetailPage() {
  const { id } = useParams();
  ...
  if (!model) return <div className="p-6 text-gray-600">Model not found</div>;
    ...
    <div className="space-y-8 bg-gray-50 min-h-screen p-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1 ml-11">Vehicle model details and variants</p>
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        {variants.length === 0 ? (
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-12 text-center">
            ...
            <p className="text-gray-500">This vehicle model has no variants configured</p>
          </div>
        ) : (
              ...
              <div key={v.id} className="bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 group">
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="pt-4 border-t border-gray-100">
                    <Link
                      to={`/evm-staff/vehicles/${id}/variants/${v.id}`}
