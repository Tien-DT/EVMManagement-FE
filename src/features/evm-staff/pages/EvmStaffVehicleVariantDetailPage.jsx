...
import { useVehicleVariantDetail } from "../../vehicle/hooks/useVehicleVariants";

export default function EvmStaffVehicleVariantDetailPage() {
  const { id: modelId, variantId } = useParams();
  const navigate = useNavigate();
  const { variant, loading, error } = useVehicleVariantDetail(variantId);
