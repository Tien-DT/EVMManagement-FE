// src/features/dealer-manager/components/DealerManagerSignatureModal.jsx
...
/**
 * Modal xử lý Digital Signature cho Dealer Manager
 ...
 */
const DealerManagerSignatureModal = ({
  visible,
  onClose,
  onSuccess,
  documentType,
  ...
  return (
    <Modal
      title={
        <Space>
          <SafetyOutlined />
          Chữ ký số điện tử - Dealer Manager
        </Space>
      }
      open={visible}
      onCancel={onClose}
...
export default DealerManagerSignatureModal;
