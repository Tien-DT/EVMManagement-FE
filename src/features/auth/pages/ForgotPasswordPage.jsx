            ...
            <form onSubmit={otpForm.handleSubmit(onOtpSubmit)} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 transition text-center text-lg tracking-widest uppercase ${
