...
const ChangePasswordModal = ({ isOpen, onClose }) => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      // Try the test function first to find the correct field names
      const response = await authService.testChangePassword({
      ...
      // Handle different response structures - be more flexible with success detection
      ...
      if (isSuccess) {
        ...
        const errorMessage = response?.message || response?.data?.message || "Failed to change password. Please try again.";
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <div>
                  ...
                  {form.formState.errors.currentPassword && (
                    <p className="mt-1 text-sm text-red-600">{form.formState.errors.currentPassword.message}</p>
                  )}
                </div>
