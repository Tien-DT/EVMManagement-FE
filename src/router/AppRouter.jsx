...
import DealerManagerDetailPage from "../features/admin/pages/DealerManagerDetailPage";
      ...
      <Route element={<PrivateRoute />}>
        <Route element={<RoleBasedRoute allowedRoles={["admin"]} />}>
          <Route element={<AdminLayout />}>
            ...
            />
            <Route
              path="/admin/dealer-managers/:id"
              element={<DealerManagerDetailPage />}
            />
      ...
      <Route element={<PrivateRoute />}>
        <Route element={<RoleBasedRoute allowedRoles={["dealer"]} />}>
          <Route element={<DealerManagerLayout />}>
            ...
            {/* Test Drive Schedule Routes */}
            <Route
              path="/dealer-manager/test-drive-schedule"
              element={<TestDriveSchedulePage />}
            />
            <Route
              path="/dealer-manager/test-drive-schedule/create"
      ...
      <Route element={<PrivateRoute />}>
        <Route element={<RoleBasedRoute allowedRoles={["evm-staff"]} />}>
          <Route element={<EvmStaffLayout />}>
            ...
            />
            <Route
              path="/evm-staff/contracts/create"
              element={<EvmStaffCreateContractPage />}
            />
            <Route
            ...
            />
            <Route
              path="/evm-staff/contracts/edit/:id"
              element={<EvmStaffContractDetailPage />}
            />
